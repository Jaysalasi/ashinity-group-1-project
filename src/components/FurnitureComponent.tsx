    ...
    <>
      <section className="py-12 text-gray-700">
        ...
        <div className="container mx-auto px-4">
          <div className="grid auto-rows-auto grid-cols-1 md:grid-cols-5 gap-4 place-content-around">
            <div className='col-span-2 grid grid-cols-5 grid-rows-2 gap-4 justify-items-stretch place-content-around'>
            ...
            <div className='hidden sm:grid auto-rows-auto col-span-2 grid-cols-6 grid-rows-2 gap-4 justify-items-stretch place-content-around'>
